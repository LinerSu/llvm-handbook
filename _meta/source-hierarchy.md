...
2. **Canonical papers & texts.** e.g. Kildall 1973 (dataflow), Cousot & Cousot 1977 (abstract interpretation), Cytron et al. 1991 (SSA), Wegman & Zadeck 1991 (SCCP), Lattner & Adve (DSA); and **Muchnick, *Advanced Compiler Design & Implementation* (1997)** for implementation-level algorithms (SSA, PRE, value numbering, register allocation, scheduling) — see [[muchnick.MOC]].
